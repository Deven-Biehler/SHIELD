...
if __name__ == "__main__":
    ...
    for dataset in config['datasets']:
        ...
        stage1(config['input_file'], config['scale'])
        ...
        #     "Full Number of Points": dataset["file"],	
        #     "Points After Reduction": len(df),	
        #     "Reduction/Original Ratio": percent_reduced/1000,	
        #     "Runtime (s)": total_time,
        #     "scale": dataset['scale']
        # }

        # pd.DataFrame([results_meta_data]).to_csv(f"reduced results/results_metadata.csv", index=False, mode='a', header=False)
